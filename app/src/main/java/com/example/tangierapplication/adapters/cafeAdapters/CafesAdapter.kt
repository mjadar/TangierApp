...
class CafesAdapter(
    options: FirestoreRecyclerOptions<Cafe>
) : FirestoreRecyclerAdapter<Cafe,CafesAdapter.TodoViewHolder>(options){
    ...
    override fun onBindViewHolder(holder: TodoViewHolder, position: Int, model: Cafe) {

        holder.itemView.apply {
            model.cafeId=snapshots.getSnapshot(position).id
